<header class="header fixed top-0 z-10 left-0 right-0 flex items-stretch shrink-0 bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark]" data-sticky="true" data-sticky-class="shadow-sm" data-sticky-name="header" id="header">
    ...
    <div class="container-fixed flex justify-between items-stretch lg:gap-4" id="header_container">
        ...
        <div class="flex gap-1 lg:hidden items-center -ml-1">
            <a class="shrink-0" href="{{ panel_route('home.index') }}">
                <img class="max-h-[25px] w-full" src="{{ image_origin(system_setting('panel_logo', 'images/logo-panel.png')) }}" />
            </a>
        ...
        <div class="flex items-stretch" id="mega_menu_container">
            <div class="flex items-stretch" data-reparent="true" data-reparent-mode="prepend|lg:prepend" data-reparent-target="body|lg:#mega_menu_container">
                <div class="hidden lg:flex lg:items-stretch" data-drawer="true" data-drawer-class="drawer drawer-start fixed z-10 top-0 bottom-0 w-full mr-5 max-w-[250px] p-5 lg:p-0 overflow-auto" data-drawer-enable="true|lg:false" id="mega_menu_wrapper">
                ...
                <div class="dropdown-content light:border-gray-300 w-screen max-w-[320px]">
                    ...
                    <div class="flex flex-col scrollable-y-auto max-h-[400px] divide-y divide-gray-200">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                            <div class="flex items-center flex-wrap gap-2">
                                <div class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">
                                    <img alt="" class="size-6" src="{{ asset('media/brand-logos/inferno.svg') }}" />
                                </div>
                                <div class="flex flex-col">
                                    <a class="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">
                                        Inferno
                        ...
                        <div class="flex flex-col">
                            <div class="scrollable-y-auto" data-scrollable="true" data-scrollable-dependencies="#header" data-scrollable-max-height="auto" data-scrollable-offset="200px">
                                <div class="flex flex-col gap-5 pt-3 pb-4">
                                    ...
                                    <div class="flex grow gap-2.5 px-5">
                                        <div class="relative shrink-0 mt-0.5">
                                            <img alt="" class="rounded-full size-8" src="{{ asset('media/avatars/300-21.png') }}" />
                                            <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
                                            </span>
                                        </div>
                                        <div class="flex flex-col gap-3.5">
            ...
            <div class="menu" data-menu="true">
                <div class="menu-item" data-menu-item-offset="20px, 10px" data-menu-item-placement="bottom-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
                    <div class="menu-toggle btn btn-icon rounded-full">
                        <img alt="" class="size-9 rounded-full border-2 border-success shrink-0" src="{{ image_origin(system_setting('panel_logo', 'images/logo-panel.png')) }}">
                        </img>
                    </div>
                    <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
                        <div class="flex items-center justify-between px-5 py-1.5 gap-1.5">
                            <div class="flex items-center gap-2">
                                <img alt="" class="size-9 rounded-full border-2 border-success" src="{{ image_origin(system_setting('panel_logo', 'images/logo-panel.png')) }}">
                                <div class="flex flex-col gap-1.5">
                                    <span class="text-sm text-gray-800 font-semibold leading-none">
                                        {{ current_admin()->name }}
                                    </span>
                                    <a class="text-xs text-gray-600 hover:text-primary font-medium leading-none" href="{{ panel_route('home.index') }}">
                                        {{ current_admin()->email }}
                                    </a>
                                </div>
                                </img>
                        ...
                        <div class="flex flex-col">
                            <div class="menu-item">
                                <a class="menu-link" href="{{ front_route('home.index') }}" target="_blank">
                                    <span class="menu-icon">
                                        <i class="ki-filled ki-badge">
                                        </i>
                                    </span>
                                    <span class="menu-title">
                                        {{ __('panel/dashboard.frontend') }}
                                    </span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="{{ panel_route('account.index') }}">
                                    <span class="menu-icon">
                                        <i class="ki-filled ki-profile-circle">
                                        </i>
                                    </span>
                                    <span class="menu-title">
                                        {{ __('panel/dashboard.profile') }}
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="menu-item" data-menu-item-offset="-10px, 0" data-menu-item-placement="left-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
                                <div class="menu-link">
                                    ...
                                    <span class="menu-title">
                                        {{ __('panel/dashboard.language') }}
                                    </span>
                                    <div class="flex items-center gap-1.5 rounded-md border border-gray-300 text-gray-600 p-1.5 text-2xs font-medium shrink-0">
                                        {{ current_panel_locale()['name'] }}
                                        <img alt="" class="inline-block size-3.5 rounded-full" src="{{ image_origin('images/flag/'. panel_locale_code().'.png') }}" />
                                    </div>
                                </div>
                                <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[170px]">
                                    @foreach (panel_locales() as $locale)
                                    <div class="menu-item {{current_panel_locale()['name'] == $locale['name'] ? 'active' : ''}}">
                                        <a class="menu-link h-10" href="{{ panel_route('locale.switch', ['code'=> $locale['code']]) }}">
                                            <span class="menu-icon">
                                                <img alt="" class="inline-block size-4 rounded-full" src="{{ image_origin($locale['image']) }}" />
                                            </span>
                                            <span class="menu-title">{{ $locale['name'] }}</span>

                                            @if( current_panel_locale()['name'] == $locale['name'] )
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="menu-item px-4 py-1.5">
                                <a class="btn btn-sm btn-light justify-center" href="{{ panel_route('logout.index') }}">
                                    {{ __('panel/dashboard.sign_out') }}
                                </a>
                            </div>
                        </div>
                    </div>
