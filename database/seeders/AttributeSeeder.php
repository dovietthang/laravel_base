...
class AttributeSeeder extends Seeder
{
    ...
    private function getGroupTranslations(): array
    {
        return [
            ...
            ['attribute_group_id' => 4, 'locale' => 'en', 'name' => 'Mặc định'],
            ['attribute_group_id' => 1, 'locale' => 'vi', 'name' => 'Quần áo'],
            ['attribute_group_id' => 2, 'locale' => 'vi', 'name' => 'Clothing'],
            ['attribute_group_id' => 3, 'locale' => 'vi', 'name' => 'Thể thao'],
            ['attribute_group_id' => 4, 'locale' => 'vi', 'name' => 'Phụ kiện'],
    ...
    private function getAttributeTranslations(): array
    {
        return [
            ...
            ['attribute_id' => 1, 'locale' => 'vi', 'name' => 'Features'],
            ['attribute_id' => 2, 'locale' => 'vi', 'name' => 'Fabric'],
            ['attribute_id' => 3, 'locale' => 'vi', 'name' => 'Style'],
            ['attribute_id' => 4, 'locale' => 'vi', 'name' => 'Cushioning'],
            ['attribute_id' => 5, 'locale' => 'vi', 'name' => 'CUP'],
            ['attribute_id' => 6, 'locale' => 'vi', 'name' => 'Memory'],
        ];
    }
    ...
    private function getAttributeValueTranslations(): array
    {
        return [
            ...
            ['attribute_value_id' => 1, 'locale' => 'vi', 'name' => 'Cotton'],
            ['attribute_value_id' => 2, 'locale' => 'vi', 'name' => 'Numb'],
            ['attribute_value_id' => 5, 'locale' => 'vi', 'name' => 'Silk'],
            ['attribute_value_id' => 6, 'locale' => 'vi', 'name' => 'Hair'],
            ['attribute_value_id' => 7, 'locale' => 'vi', 'name' => 'Chemical fiber'],
            ['attribute_value_id' => 4, 'locale' => 'vi', 'name' => 'Round neck'],
            ['attribute_value_id' => 8, 'locale' => 'vi', 'name' => 'Collarless'],
            ['attribute_value_id' => 9, 'locale' => 'vi', 'name' => 'Short sleeve'],
            ['attribute_value_id' => 10, 'locale' => 'vi', 'name' => 'T-shirt'],
            ['attribute_value_id' => 3, 'locale' => 'vi', 'name' => 'Water proof'],
            ['attribute_value_id' => 11, 'locale' => 'vi', 'name' => 'keep warm'],
            ['attribute_value_id' => 12, 'locale' => 'vi', 'name' => 'Sun protection'],
            ['attribute_value_id' => 13, 'locale' => 'vi', 'name' => 'Zoom Air Cushion'],
            ['attribute_value_id' => 14, 'locale' => 'vi', 'name' => 'Max Air Cushion'],
            ['attribute_value_id' => 15, 'locale' => 'vi', 'name' => 'Boost cushioning material'],
            ['attribute_value_id' => 16, 'locale' => 'vi', 'name' => 'Lightstrike Technology'],
            ['attribute_value_id' => 17, 'locale' => 'vi', 'name' => 'Fuel Cell Technology'],
            ['attribute_value_id' => 18, 'locale' => 'vi', 'name' => 'i3'],
            ['attribute_value_id' => 19, 'locale' => 'vi', 'name' => 'i5'],
            ['attribute_value_id' => 20, 'locale' => 'vi', 'name' => 'i7'],
            ['attribute_value_id' => 21, 'locale' => 'vi', 'name' => 'i9'],
            ['attribute_value_id' => 22, 'locale' => 'vi', 'name' => 'DDR3'],
            ['attribute_value_id' => 23, 'locale' => 'vi', 'name' => 'DDR4'],
        ];
    }
